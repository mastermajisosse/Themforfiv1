...
class PsColors {
  ...
  static const Color _c_main_color = Color(0xFFED7768);
  static const Color _c_main_light_color = Color(0xFFFDDEDA); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFFEF5743);
